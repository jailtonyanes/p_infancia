	...
	<div class="date-outer">
		...
		<div class="date-posts">
			...
			<div class='post-outer'>
                ...
                <table class="CSSTableGenerator" id="reccom" style="border: 1px solid #000">
                   
                </table> 
                <form id="ingreso_usuario" name"ingreso_usuario">
                <h2>Ingreso de usuarios</h2>
                <p>
                <label for="nombre">Nombre</label>
        <br />
                 <input type="text" class="campo_formulario" name="nombre" id="nombre">

                </p>  
                <p>
                <label for="usuario">Apellido</label>
        <br />
                 <input type="text" class="campo_formulario" name="apellido" id="apellido">

                </p>  
                 <p>
                 <label for="usuario">Contraseña</label>
        <br />
                 <input type="password" name="password" id="password" class="campo_formulario">
                 
                </p>
                <p>
                <label for="usuario">Usuario</label>
        <br />
                 <input type="text" class="campo_formulario" name="nick" id="nick">
                 
                </p>
                <p>
                <label for="usuario">Perfil</label>
        <br />
                 <select name="perfil" id="perfil" class="campo_formulario">
					  <option value="1">Administrador</option>
					  <option value="2">Párvulo</option>
					  <option value="3">Jardín</option>
					  <option value="4">Pre-Jardín</option>
        ...
        <br />
                 <select name="tipo_usuario" id="tipo_usuario" class="campo_formulario">
                    ...
                    <br />
                 <select name="activo_usuario" id="activo_usuario" class="campo_formulario">
                 ...
                 <input type="button" name="aceptar" id="aceptar" value="Guardar" onclick="ingresar_usuario()">
