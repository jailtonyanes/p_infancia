...
<div id='main-wrapper'>
<div class='main section' id='main' style="margin-left:29%">
...
<div class='blog-posts hfeed'>
			...
			<div class='post-outer'>
                 <?php
                     $crud->setConsulta("SELECT *
                                                     FROM contenido WHERE proyecto = '$_GET[proyecto]' AND unidad ='$_GET[unidad]' AND unidad_integrada_id= '$_GET[unidad_integrada]'  ");
   $info = $crud->seleccionar($con->getConection());
                 ...
                 ?>
                           ...
                           <h2> <?php echo htmlentities(trim($pedazo[$i+1],'</li>')) ?></h2>
