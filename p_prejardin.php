...
<body>
  <div id='header-outer' style="background:url('imagenes/header-3.jpg') no-repeat center">
...
<a href='<?php if(!isset($_SESSION['user_authorized'])){echo '#';}else{echo'prog_jardin.php?prog=2&uid=1';} ?>'>Unidad I: El colegio</a>
...
<a href='<?php if(!isset($_SESSION['user_authorized'])){echo '#';}else{echo'prog_jardin.php?prog=2&uid=2';} ?>'>Unidad II: La familia</a>
...
<a href='<?php if(!isset($_SESSION['user_authorized'])){echo '#';}else{echo'prog_jardin.php?prog=2&uid=3';} ?>'>Unidad III: La casa (dependencias) - mis juguetes</a>
...
<a href='<?php if(!isset($_SESSION['user_authorized'])){echo '#';}else{echo'prog_jardin.php?prog=2&uid=4';} ?>'>Unidad IV: El cuerpo humano y los sentidos</a>
...
<a href='<?php if(!isset($_SESSION['user_authorized'])){echo '#';}else{echo'prog_jardin.php?prog=2&uid=5';} ?>'>Unidad V: Aseo personal y elementos de aseo</a>
...
<a href='<?php if(!isset($_SESSION['user_authorized'])){echo '#';}else{echo'prog_jardin.php?prog=2&uid=6';} ?>'>Unidad VI: Prendas de vestir y estados del clima</a>
...
<a href='<?php if(!isset($_SESSION['user_authorized'])){echo '#';}else{echo'prog_jardin.php?prog=2&uid=7';} ?>'>Unidad VII: Las plantas y los Alimentos</a>
...
<a href='<?php if(!isset($_SESSION['user_authorized'])){echo '#';}else{echo'prog_jardin.php?prog=2&uid=8';} ?>'>Unidad VIII: La granja y animales domésticos</a></h3>
...
<a href='<?php if(!isset($_SESSION['user_authorized'])){echo '#';}else{echo'prog_jardin.php?prog=2&uid=9';} ?>'>Unidad IX: Animales acuáticos</a>
...
<a href='<?php if(!isset($_SESSION['user_authorized'])){echo '#';}else{echo'prog_jardin.php?prog=2&uid=10';} ?>'>Unidad X: Animales salvajes</a>
...
<a href='<?php if(!isset($_SESSION['user_authorized'])){echo '#';}else{echo'prog_jardin.php?prog=2&uid=11';} ?>'>Unidad XI: Medios de transporte y señal de transito: Pare</a>
...
<a href='<?php if(!isset($_SESSION['user_authorized'])){echo '#';}else{echo'prog_jardin.php?prog=2&uid=12';} ?>'>Unidad XII: Medios de comunicación</a>
...
<a href='<?php if(!isset($_SESSION['user_authorized'])){echo '#';}else{echo'prog_jardin.php?prog=2&uid=13';} ?>'>Unidad XIII: Profesiones</a>
...
<a href='<?php if(!isset($_SESSION['user_authorized'])){echo '#';}else{echo'prog_jardin.php?prog=2&uid=14';} ?>'>Unidad XIV: Oficios</a>
...
<a href='<?php if(!isset($_SESSION['user_authorized'])){echo '#';}else{echo'prog_jardin.php?prog=2&uid=15';} ?>'>Unidad XV: Mi país</a>
...
<a href='<?php if(!isset($_SESSION['user_authorized'])){echo '#';}else{echo'prog_jardin.php?prog=2&uid=16';} ?>'>Unidad XVI: Navidad </a>
...
<a class='home-link' href='p_prejardin.php?prog=2'>Proyecto Pre-jardín</a>
</div>
<div class='clear'></div>
