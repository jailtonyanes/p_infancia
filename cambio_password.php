...
<div class='blog-posts hfeed'>
	...
	<div class="date-outer">
        ...
        <br />
                 <input type="text" class="campo_formulario" name="usuario" id="usuario">

                </p>
                <p>
                <label for="nombre">Contraseña anterior</label>
        <br />
                 <input type="password" class="campo_formulario" name="passwordd" id="passwordd">

                </p>  
                <p>
                <label for="usuario">Nueva contraseña</label>
        <br />
                 <input type="password" class="campo_formulario" name="nueva_contra" id="nueva_contra">

                </p>  
                 <p>
                 <label for="usuario">Confirme contraseña</label>
        <br />
                 <input type="password" name="confi_password" id="confi_password" class="campo_formulario">
                 ...
                 <input type="button" name="aceptar" id="aceptar" value="Actualizar" onclick="cambiar_password()">
...
<a class='home-link' href='index.php'>Ingresar</a>
</div>
<div class='clear'></div>
...
<script type="text/javascript" src="js/cambiar_password.js"></script>
</div></div>
</div>
<!-- Sidebar -->
