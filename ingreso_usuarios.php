	...
	<div class="date-outer">
		...
		<div class="date-posts">
			...
			<div class='post-outer'>
                ...
                <form name="ingreso" id ="ingreso" style=" border: 1px solid #000;
    padding: 10px;
    width: 254px;
    margin-left:-16px">
    <input type="hidden" name="ocul" id="ocul" class="ancho" />
    <h2 style="padding-left:26px"> Ingreso de Usuarios</h2>
                	<p>
                	...
                	<p>
                		<label for="nombre">*Usuario:</label>
                		 <br/>
                		<input type="text" name="nick" id="nick" class="ancho" />
                	</p>
                	<p>
                		<label for="nombre">*Password:</label>
                		 <br/>
                		<input type="password" name="password" id="password" class="ancho" />
                	</p>
                	<p>
                	...
                	<p>
                		...
                		<br/>
                		<select name="perfil" id="perfil" class="ancho2">
                			<option value="0">Escoja Opción</option>
                			<option value="3">Párvulo</option>
                			<option value="2">Pre-jardín</option>
                	...
                	<p>
                		<label for="nombre">*Estado de usuario:</label>
                		<br/>
                		<select name="estado" id="estado" class="ancho2">
                				<option value="0">Escoja Opción</option>
                	...
                	<p><input type="button" onclick="ingresar_usuarios()" value="Enviar" id="guardar" name="guardar" /></p>
...
<script type="text/javascript" src="js/ingreso_usuarios.js"></script>
</div></div>
</div>
<!-- Sidebar -->
