...
<div class='post-outer' >
       <h2 style="padding-left:30%">INSCRIPCIONES ABIERTAS </h2>
      <!-- Carrusel 1 -->
      <div id="slidebox">
      ...
      <a href="#" onClick="" class="2">2</a> 
        ...
        <ul>
            <li><img src="img/in1.png"  alt="img1" /></li>
            <li><img src="img/in2.jpg"  alt="img2" /></li>
      ...
      <!-- fin Carrusel 1 -->
          ...
          <h2 style="padding-left:30%">LA INSTITUCIÓN </h2>
      <!-- Carrusel 2 -->
      <div id="slidebox2">
